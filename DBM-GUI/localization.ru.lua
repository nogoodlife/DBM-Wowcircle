...
L.Website					= "Discord для обсуждения: |cFF73C2FBNO DISCORD CURRENTLY|r"
...
--Types
L.BarStartColorAdd			= "Нач. цвет\n(Помощник)"
L.BarEndColorAdd			= "Конечный цвет\n(Помощник)"
L.BarStartColorAOE			= "Нач. цвет\n(AoE)"
L.BarEndColorAOE			= "Конечный цвет\n(AoE)"
L.BarStartColorDebuff		= "Нач. цвет\n(Цель)"
L.BarEndColorDebuff			= "Конечный цвет\n(Цель)"
L.BarStartColorInterrupt	= "Нач. цвет\n(Прерывание)"
L.BarEndColorInterrupt		= "Конечный цвет\n(Прерывание)"
L.BarStartColorRole			= "Нач. цвет\n(Роль)"
L.BarEndColorRole			= "Конечный цвет\n(Роль)"
L.BarStartColorPhase		= "Нач. цвет\n(Фаза)"
L.BarEndColorPhase			= "Конечный цвет\n(Фаза)"
L.BarStartColorUI			= "Нач. цвет\n(Польз.)"
...
L.Bar_Decimal				= "Показать десятые, когда время < %d"
L.Bar_Alpha					= "Прозрачность: %0.1f"
L.Bar_EnlargeTime			= "Увеличить, когда время < %d"
