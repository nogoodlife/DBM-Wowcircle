...
L.AUTO_SPEC_WARN_TEXTS.dispel			= "%s на |3-5(>%%s<) - рассей заклинание"
L.AUTO_SPEC_WARN_TEXTS.interrupt		= "%s - прерви >%%s<!"
L.AUTO_SPEC_WARN_TEXTS.interruptcount	= "%s - прерви >%%s<! (%%d)"
...
L.AUTO_SPEC_WARN_TEXTS.moveaway			= "%s - отбеги от остальных"
L.AUTO_SPEC_WARN_TEXTS.moveawaycount	= "%s (%%s) - отбеги от остальных"
...
L.AUTO_SPEC_WARN_TEXTS.runcount 		= "%s - убегай (%%s)"
L.AUTO_SPEC_WARN_TEXTS.cast				= "%s - прекрати чтение заклинаний"
...
L.AUTO_SPEC_WARN_TEXTS.gtfo				= "Под вами %%s - выбеги"
...
L.AUTO_SPEC_WARN_OPTIONS.move			= "Спецпредупреждение \"отбеги\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.keepmove		= "Спецпредупреждение \"продолжай двигаться\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.stopmove		= "Спецпредупреждение \"остановись\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.dodge			= "Спецпредупреждение \"избегай\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.dodgecount		= "Спецпредупреждение \"избегай\" (со счётчиком) для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.dodgeloc		= "Спецпредупреждение \"избегай\" (с местом) для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.moveaway		= "Спецпредупреждение \"отбеги от остальных\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.moveawaycount	= "Спецпредупреждение \"отбеги от остальных\" (со счётчиком) для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.moveto			= "Спецпредупреждение \"беги к кому-то\", на ком $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.soak			= "Спецпредупреждение \"перекрой\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.soakcount		= "Спецпредупреждение \"перекрой\" (со счётчиком) для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.jump			= "Спецпредупреждение \"подпрыгни\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.run			= "Спецпредупреждение \"убегай\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.runcount		= "Спецпредупреждение (со счётчиком) \"убегай\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.cast			= "Спецпредупреждение \"прекрати чтение заклинаний\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.lookaway		= "Спецпредупреждение \"отвернись\" для $spell:%s"
L.AUTO_SPEC_WARN_OPTIONS.reflect		= "Спецпредупреждение \"прекрати атаку\" для $spell:%s"
...
L.AUTO_TIMER_OPTIONS.cdcount		= "Отсчёт времени (со счётчиком) до восстановления $spell:%s (%ss)"
